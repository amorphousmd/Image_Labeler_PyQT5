...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.load_annotate_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.load_annotate_button.setObjectName("load_annotate_button")
        self.verticalLayout.addWidget(self.finish_button)
        self.verticalLayout.addWidget(self.load_annotate_button)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.finish_button.setText(_translate("Dialog", "Save Annotations"))
        self.load_annotate_button.setText(_translate("Dialog", "Load Annotations"))
